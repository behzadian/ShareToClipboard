...
For example when user take a screenshot and wants to use it in a reply tweet (which is not available through Twitter app share screen), he/she can just copy the screenshot and then, open the Twitter application, find desired tweet to reply and then paste the screenshot:

![iPhone copy button](./assets/rm-01-iphone-copy-screenshot.jpg)
